/* Ziptility Practice Tests practice-v1.3.0 (3b3ef4530750fc7dafbdc1d489138a09774df8b1) — https://github.com/BlakeAndersonZiptility/ziptility-tools */
...
`;var ce={calcUrl:"/tools/calculator",formulaSheetUrl:"/tools/formula-sheets",contactEmail:"sales@ziptility.com"};var de="https://blakeandersonziptility.github.io/ziptility-tools/dist/practice-banks/",D=[{id:"operator-math-1",title:"Operator math practice test",badge:"Operator math \xB7 Levels 1-2 (ABC Class I-II)",discipline:"Operator Math",level:"Levels 1-2 (ABC Class I-II)",questionCount:110,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"regulations-1",title:"Water and wastewater regulations practice test (federal)",badge:"Federal regulations \xB7 Entry to working level",discipline:"Regulations (Federal)",level:"Entry to working level (ABC Class I-II)",questionCount:103,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"wd-1",title:"Water distribution operator practice test, Class I",badge:"Water distribution \xB7 Class I entry level",discipline:"Water Distribution",level:"Entry level (ABC Class I)",description:"Mains, valves, hydrants, storage, pumps, cross-connection control, flushing, sampling, and crew safety. Machine-checked math and cited answers.",questionCount:125,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"wwc-1",title:"Wastewater collection operator practice test, Class I",badge:"Wastewater collection \xB7 Class I entry level",discipline:"Wastewater Collections",level:"Entry level (ABC Class I)",description:"Gravity mains, manholes, lift stations, cleaning and CCTV, infiltration and inflow, SSO response, and confined-space and trench safety. Cited answers throughout.",questionCount:120,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"wt-1",title:"Water treatment operator practice test, Class I",badge:"Water treatment \xB7 Class I entry level",discipline:"Water Treatment",level:"Entry level (ABC Class I)",description:"Coagulation and jar testing, sedimentation, filtration, disinfection and CT, source water, plant pumps and chemical feeders, lab work, and chlorine safety. Machine-checked math and cited answers.",questionCount:128,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"wwt-1",title:"Wastewater treatment operator practice test, Class I",badge:"Wastewater treatment \xB7 Class I entry level",discipline:"Wastewater Treatment",level:"Entry level (ABC Class I)",description:"Preliminary and primary treatment, activated sludge, clarifiers, trickling filters and lagoons, disinfection, solids handling, blowers and clarifier drives, lab work, and H2S and confined-space safety. Cited answers throughout.",questionCount:119,durationMin:120,refCount:100,bankVersion:"1.0.0"}];function Me(e){let r=new Set;for(let n of e){if(!n||!n.id)throw new Error("practice manifest: entry missing id");if(r.has(n.id))throw new Error('practice manifest: duplicate id "'+n.id+'"');if(r.add(n.id),!n.title||!n.badge||!n.discipline||!n.level)throw new Error('practice manifest: "'+n.id+'" is missing a required label field');if(!Number.isInteger(n.questionCount)||n.questionCount<=0)throw new Error('practice manifest: "'+n.id+'" has a bad questionCount');if(!Number.isInteger(n.durationMin)||n.durationMin<=0)throw new Error('practice manifest: "'+n.id+'" has a bad durationMin');if(!Number.isInteger(n.refCount)||n.refCount<=0)throw new Error('practice manifest: "'+n.id+'" has a bad refCount');if(!/^\d+\.\d+\.\d+$/.test(n.bankVersion||""))throw new Error('practice manifest: "'+n.id+'" has a malformed bankVersion')}return!0}Me(D);var F=new Map;async function le(e,r,n){let c=e+"-v"+r;if(F.has(c))return F.get(c);let f=n+c+".json",m=new AbortController,C=setTimeout(()=>m.abort(),1e4),z;try{z=await fetch(f,{signal:m.signal})}finally{clearTimeout(C)}if(!z.ok)throw new Error("practice bank fetch failed: "+f+" ("+z.status+")");let o=await z.json();return F.set(c,o),o}var Ae={"operator-math-1":"Unit conversions, flow, dosing, and the 8.34 pounds formula, worked out in plain English."};function k(e,r,n){let c=document.createElement(e);return r&&(c.className=r),n!=null&&(c.textContent=n),c}function K(e){for(;e.firstChild;)e.removeChild(e.firstChild)}function pe(e,{onSelect:r}){K(e),e.appendChild(k("h2","zq-hub-section-title","Pick your test"));let n=k("div","zq-hub-grid");D.forEach(c=>{let f=k("button","zq-hubcard");f.type="button",f.appendChild(k("span","zq-eyebrow",c.discipline)),f.appendChild(k("h3",null,c.title)),f.appendChild(k("p",null,Ae[c.id]||"")),f.appendChild(k("div","zq-meta",c.questionCount+" questions \xB7 practice or timed exam")),f.addEventListener("click",()=>r(c)),n.appendChild(f)}),e.appendChild(n)}function ue(e){K(e);let r=k("div","zq-loading");r.appendChild(k("span","zq-spinner")),r.appendChild(k("span",null,"Loading questions\u2026")),e.appendChild(r)}function fe(e,{message:r,onRetry:n}){K(e);let c=k("div","zq-error");c.setAttribute("role","alert"),c.appendChild(k("h3",null,"Could not load this test")),c.appendChild(k("p",null,r||"The question set did not load. Check your connection and try again."));let f=k("button","zq-btn zq-btn-secondary","Try again");f.type="button",f.addEventListener("click",n),c.appendChild(f),e.appendChild(c)}function Y(e){for(let r=e.length-1;r>0;r--){let n=Math.floor(Math.random()*(r+1)),c=e[r];e[r]=e[n],e[n]=c}return e}function J(e){let r=Math.floor(e/60),n=e%60;return r+":"+(n<10?"0":"")+n}function he(e){let r=[],n=[25,50,100];for(let c of n)c<e&&r.push(c);return r.push(e),r}function X(e,r,n,c){let f=r||n;return Math.max(10,Math.round((c||120)*e/f))}function me(e,r,n){let c=new Set(r||[]),f=[],m=[];for(let z of e)(c.has(z.id)?m:f).push(z);Y(f),Y(m);let C=f.concat(m).slice(0,n);return Y(C),C.map(z=>{let o=Y([0,1,2,3]);return{q:z,order:o,correctPos:o.indexOf(z.correctIndex)}})}function ze(e,r){let n=e.length,c=0,f={},m=[];for(let z=0;z<n;z++){let o=e[z],y=o.q.domain||"General";f[y]||(f[y]={n:0,ok:0}),f[y].n+=1;let S=z in r?r[z]:null;S===o.correctPos?(c+=1,f[y].ok+=1):m.push({item:o,sel:S})}let C=Math.round(100*c/n);return{correct:c,n,pct:C,byDomain:f,missed:m}}function ge(e){return Object.keys(e).sort((r,n)=>e[r].ok/e[r].n-e[n].ok/e[n].n)}var be={MATH:"Operator math",CHEM:"Chemistry",MICRO:"Microbiology",REGS:"Regulations",SAMP:"Sampling",SAFE:"Safety",PROC:"Process control",EQIP:"Equipment",ADMIN:"Administration",Multiple:"Mixed topics"};function Be(e){try{return window.localStorage.getItem(e)}catch{return null}}function Z(e,r){try{window.localStorage.setItem(e,r)}catch{}}function Ne(e){try{window.localStorage.removeItem(e)}catch{}}function W(e){let r=Be(e);if(!r)return null;try{return JSON.parse(r)}catch{return null}}function t(e,r,n){let c=document.createElement(e);return r&&(c.className=r),n!=null&&(c.textContent=n),c}function _(e){for(;e.firstChild;)e.removeChild(e.firstChild)}var Oe='<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 8h10M9 4l4 4-4 4"/></svg>';function L(e,r,{arrow:n=!1}={}){let c=t("button",r);c.type="button";let f=t("span","zq-btn-label",e);if(c.appendChild(f),n){let m=document.createElement("span");m.className="zq-arrow",m.innerHTML=Oe,c.appendChild(m)}return c}function Pe(e,r){let n=e.querySelector(".zq-btn-label");n&&(n.textContent=r)}function ve(e,r,n,{onExit:c}={}){let f="zpt-pt-session-"+r.id,m="zpt-pt-history-"+r.id,C="zpt-pt-seen-"+r.id,z={};for(let i of r.questions)z[i.id]=i;_(e);let o=t("div"),y=t("div","zq-visually-hidden");y.setAttribute("aria-live","polite"),e.appendChild(o),e.appendChild(y);function S(i){y.textContent=i}let a=null,E={mode:"practice",size:null};function O(){a&&Z(f,JSON.stringify({v:1,bankVersion:r.version||"",mode:a.mode,size:a.size,qids:a.qs.map(i=>i.q.id),orders:a.qs.map(i=>i.order),answers:a.answers,checked:a.checked,idx:a.idx,remainingSec:a.remainingSec}))}function xe(){let i=W(f);if(!i||i.v!==1||i.bankVersion!==(r.version||"")||!i.qids||!i.qids.length)return null;for(let l of i.qids)if(!z[l])return null;return i}function U(){Ne(f)}function ye(i){let l=W(m)||[];l.unshift(i),l.length>25&&(l=l.slice(0,25)),Z(m,JSON.stringify(l))}function we(i){let s=(W(C)||[]).concat(i);s.length>600&&(s=s.slice(s.length-600)),Z(C,JSON.stringify(s))}function G(){H(),a=null,_(o);let i=t("div");i.appendChild(t("span","zq-badge",n.badge||r.discipline||"")),i.appendChild(t("h2","zq-title",n.title||r.title)),o.appendChild(i);let l=xe();if(l){let d=t("div","zq-resume"),p=t("div");p.appendChild(t("strong",null,"You have a test in progress. ")),p.appendChild(document.createTextNode((l.mode==="exam"?"Timed exam":"Practice")+", question "+(l.idx+1)+" of "+l.qids.length+".")),d.appendChild(p);let u=t("div","zq-navrow"),h=L("Resume","zq-btn zq-btn-primary",{arrow:!0});h.addEventListener("click",()=>Ce(l));let q=L("Discard","zq-btn zq-btn-quiet");q.addEventListener("click",()=>{U(),G()}),u.appendChild(h),u.appendChild(q),d.appendChild(u),o.appendChild(d)}let s=t("div","zq-card");s.appendChild(t("h2",null,"Set up your test"));let b=t("div","zq-mode-grid"),v=[{id:"practice",name:"Practice",desc:"Check each answer as you go. Every question shows a plain-English explanation."},{id:"exam",name:"Timed exam",desc:"No feedback until the end, with a clock running. The closest thing to test day."}],x={};v.forEach(d=>{let p=t("button","zq-mode"+(E.mode===d.id?" zq-selected":""));p.type="button",p.appendChild(t("h3",null,d.name)),p.appendChild(t("p",null,d.desc)),p.addEventListener("click",()=>{E.mode=d.id;for(let u in x)x[u].classList.toggle("zq-selected",u===d.id);j()}),x[d.id]=p,b.appendChild(p)}),s.appendChild(b);let g=he(r.questions.length);(E.size===null||g.indexOf(E.size)===-1)&&(E.size=g[0]);let M=t("div","zq-size-row"),A={};g.forEach(d=>{let p=t("button","zq-size"+(E.size===d?" zq-selected":""));p.type="button",p.appendChild(document.createTextNode(d===r.questions.length&&g.length>1?"All "+d:String(d))),p.appendChild(t("small",null,"questions")),p.addEventListener("click",()=>{E.size=d;for(let u in A)A[u].classList.toggle("zq-selected",Number(u)===d);j()}),A[d]=p,M.appendChild(p)}),s.appendChild(M);let T=t("div","zq-navrow"),B=L("","zq-btn zq-btn-primary",{arrow:!0});B.addEventListener("click",()=>$(E.mode,E.size)),T.appendChild(B),s.appendChild(T),o.appendChild(s);function j(){Pe(B,E.mode==="exam"?"Start timed exam ("+E.size+" questions, "+X(E.size,r.refCount,r.questions.length,r.durationMin)+" min)":"Start practice ("+E.size+" questions)")}j();let w=W(m)||[];if(w.length){let d=0;for(let p of w)p.scorePct>d&&(d=p.scorePct);o.appendChild(t("p","zq-best","Your best score on this test so far: "+d+" percent. Attempts: "+w.length+"."))}}function $(i,l){U();let s=W(C)||[];a={mode:i,size:l,qs:me(r.questions,s,l),idx:0,answers:{},checked:{},remainingSec:i==="exam"?X(l,r.refCount,r.questions.length,r.durationMin)*60:0,timerId:null},O(),i==="exam"&&te(),P()}function Ce(i){a={mode:i.mode,size:i.size,qs:i.qids.map((l,s)=>{let b=z[l],v=i.orders[s];return{q:b,order:v,correctPos:v.indexOf(b.correctIndex)}}),idx:i.idx||0,answers:i.answers||{},checked:i.checked||{},remainingSec:i.remainingSec||0,timerId:null},a.mode==="exam"&&te(),P()}function ee(){let i=e.querySelector(".zq-timer");i&&(i.textContent=J(Math.max(0,a.remainingSec)),i.classList.toggle("zq-low",a.remainingSec<=120)),a.remainingSec%15===0&&O(),a.remainingSec<=0&&(S("Time is up. Scoring your exam."),Q())}function te(){H(),a.timerId=setInterval(()=>{a.remainingSec-=1,ee()},1e3)}function H(){a&&a.timerId&&(clearInterval(a.timerId),a.timerId=null)}function P(){_(o);let i=a.qs[a.idx],l=i.q,s=a.qs.length,b=!!a.checked[a.idx],v=a.idx in a.answers?a.answers[a.idx]:null,x=t("div","zq-topbar"),g=t("div");if(g.appendChild(document.createTextNode("Question "+(a.idx+1)+" of "+s+"  ")),g.appendChild(t("span","zq-domchip",be[l.domain]||l.domain||"General")),x.appendChild(g),a.mode==="exam"){let d=t("span","zq-timer",J(Math.max(0,a.remainingSec)));a.remainingSec<=120&&d.classList.add("zq-low"),x.appendChild(d)}o.appendChild(x);let M=t("div","zq-progressbar"),A=t("i");A.style.width=Math.round(100*a.idx/s)+"%",M.appendChild(A),o.appendChild(M);let T=t("div","zq-card");T.appendChild(t("div","zq-stem",l.text));let B=t("ul","zq-choices"),j=["A","B","C","D"];i.order.forEach((d,p)=>{let u=t("li"),h=t("button","zq-choice");h.type="button",h.appendChild(t("span","zq-letter",j[p])),h.appendChild(t("span",null,l.choices[d])),v===p&&h.classList.add("zq-selected"),b?(h.disabled=!0,p===i.correctPos?(h.classList.remove("zq-selected"),h.classList.add("zq-correct")):v===p&&(h.classList.remove("zq-selected"),h.classList.add("zq-wrong"))):h.addEventListener("click",()=>ie(p)),u.appendChild(h),B.appendChild(u)}),T.appendChild(B),b&&T.appendChild(ke(i,v));let w=t("div","zq-navrow");if(a.mode==="exam"){let d=L("Previous","zq-btn zq-btn-quiet");if(d.disabled=a.idx===0,d.addEventListener("click",()=>{a.idx-=1,O(),P()}),w.appendChild(d),w.appendChild(t("span","zq-spacer")),a.idx<s-1){let h=L("Next","zq-btn zq-btn-primary",{arrow:!0});h.addEventListener("click",()=>{a.idx+=1,O(),P()}),w.appendChild(h)}let p=0;for(let h in a.answers)a.answers[h]!==null&&p++;let u=L("Submit ("+p+"/"+s+" answered)",a.idx===s-1?"zq-btn zq-btn-primary":"zq-btn zq-btn-secondary");u.addEventListener("click",()=>{p<s&&!window.confirm("You have unanswered questions. Submit anyway?")||Q()}),w.appendChild(u)}else if(w.appendChild(t("span","zq-spacer")),b){let d=L(a.idx<s-1?"Next question":"See your score","zq-btn zq-btn-primary",{arrow:!0});d.setAttribute("data-zq-next",""),d.addEventListener("click",()=>{a.idx<s-1?(a.idx+=1,O(),P()):Q()}),w.appendChild(d)}else{let d=L("Check answer","zq-btn zq-btn-primary");d.setAttribute("data-zq-check",""),d.disabled=v===null,d.addEventListener("click",re),w.appendChild(d)}T.appendChild(w),o.appendChild(T);try{e.scrollIntoView({block:"start"})}catch{}}function ie(i){a.answers[a.idx]=i,O(),P()}function re(){if(!(a.idx in a.answers))return;a.checked[a.idx]=!0,O();let i=a.qs[a.idx];S(a.answers[a.idx]===i.correctPos?"Correct.":"Not quite. The explanation is shown below."),P()}function ke(i,l){let s=i.q,b=l===i.correctPos,v=t("div","zq-feedback "+(b?"zq-ok":"zq-err"));v.appendChild(t("h4",b?"zq-okt":"zq-errt",b?"Correct":"Not quite")),s.explanation&&v.appendChild(t("p","zq-explain",s.explanation)),s.formula&&v.appendChild(t("div","zq-formula",s.formula)),s.citation&&v.appendChild(t("div","zq-cite","Source: "+s.citation));let x=t("div","zq-minilinks");if(s.calculator&&n.calcUrl){let g=t("a",null,"Run this math in the Operator Calculator");g.href=n.calcUrl+"#"+s.calculator,g.target="_blank",g.rel="noopener",x.appendChild(g)}if(n.contactEmail){let g=t("a",null,"Report a problem with this question");g.href="mailto:"+n.contactEmail+"?subject="+encodeURIComponent("Practice test question "+s.id),x.appendChild(g)}return x.childNodes.length&&v.appendChild(x),v}function Q(){H();let{correct:i,n:l,pct:s,byDomain:b,missed:v}=ze(a.qs,a.answers);ye({date:new Date().toISOString().slice(0,10),mode:a.mode,size:l,scorePct:s}),we(a.qs.map(x=>x.q.id)),U(),Se(s,i,l,b,v)}function Se(i,l,s,b,v){_(o);let x=i>=70,g=t("div","zq-card zq-score-hero");g.appendChild(t("div","zq-score-num "+(x?"zq-pass":"zq-fail"),i+"%")),g.appendChild(t("div","zq-score-verdict "+(x?"zq-tag-ok":"zq-tag-err"),x?"Pass at the 70 percent line":"Below the 70 percent line")),g.appendChild(t("div","zq-score-sub",l+" of "+s+" correct"+(a.mode==="exam"?" on a timed exam":""))),g.appendChild(t("p","zq-passnote","Most states set the pass line at 70 percent. Your state's rules govern, so check your certification program for the real requirement.")),S("You scored "+i+" percent, "+l+" of "+s+" correct. "+(x?"That clears the 70 percent line.":"That is below the 70 percent line."));let M=t("div","zq-navrow zq-navrow-center"),A=L("Take it again (new draw)","zq-btn zq-btn-primary",{arrow:!0});A.addEventListener("click",()=>$(a.mode,s));let T=L("Change setup","zq-btn zq-btn-secondary");T.addEventListener("click",G);let B=L("All practice tests","zq-btn zq-btn-quiet");if(B.addEventListener("click",()=>{c&&c()}),M.appendChild(A),M.appendChild(T),M.appendChild(B),g.appendChild(M),o.appendChild(g),Object.keys(b).length>1){let p=t("div","zq-card zq-dombars");p.appendChild(t("h3",null,"Where you stand by topic")),ge(b).forEach(u=>{let h=b[u],q=Math.round(100*h.ok/h.n),I=t("div","zq-dombar"+(q<70?" zq-weak":"")),R=t("div","zq-domlabel");R.appendChild(t("span",null,be[u]||u)),R.appendChild(t("span",null,h.ok+"/"+h.n+" ("+q+"%)")),I.appendChild(R);let N=t("div","zq-track"),oe=t("span","zq-fill");oe.style.width=q+"%",N.appendChild(oe),I.appendChild(N),p.appendChild(I)}),o.appendChild(p)}if(v.length){let p=t("div","zq-card zq-missed");p.appendChild(t("h3",null,"Review what you missed ("+v.length+")")),v.forEach(u=>{let h=t("details");h.appendChild(t("summary",null,u.item.q.text));let q=t("div","zq-missed-body"),I=["A","B","C","D"];if(u.sel!==null&&u.sel!==void 0){let N=t("p");N.appendChild(t("span","zq-tag-err","Your answer: ")),N.appendChild(document.createTextNode(I[u.sel]+". "+u.item.q.choices[u.item.order[u.sel]])),q.appendChild(N)}else{let N=t("p");N.appendChild(t("span","zq-tag-err","Skipped.")),q.appendChild(N)}let R=t("p");R.appendChild(t("span","zq-tag-ok","Correct answer: ")),R.appendChild(document.createTextNode(I[u.item.correctPos]+". "+u.item.q.choices[u.item.q.correctIndex])),q.appendChild(R),u.item.q.explanation&&q.appendChild(t("p","zq-explain",u.item.q.explanation)),u.item.q.formula&&q.appendChild(t("div","zq-formula",u.item.q.formula)),u.item.q.citation&&q.appendChild(t("div","zq-cite","Source: "+u.item.q.citation)),h.appendChild(q),p.appendChild(h)}),o.appendChild(p)}let w=t("div","zq-capture-slot");w.hidden=!0,o.appendChild(document.createComment(" soft-capture slot: reserved, ruling 2026-07-10 ")),o.appendChild(w);let d=W(m)||[];if(d.length>1){let p=t("div","zq-card zq-history");p.appendChild(t("h3",null,"Your attempts on this test"));let u=t("table"),h=t("tr");["Date","Mode","Questions","Score"].forEach(q=>h.appendChild(t("th",null,q))),u.appendChild(h),d.slice(0,8).forEach(q=>{let I=t("tr");I.appendChild(t("td",null,q.date)),I.appendChild(t("td",null,q.mode==="exam"?"Timed":"Practice")),I.appendChild(t("td",null,String(q.size))),I.appendChild(t("td",null,q.scorePct+"%")),u.appendChild(I)}),p.appendChild(u),o.appendChild(p)}}let ne=!0,V=null;typeof IntersectionObserver=="function"&&(V=new IntersectionObserver(i=>{for(let l of i)ne=l.isIntersecting},{threshold:0}),V.observe(e));function Ee(){if(V)return ne;let i=e.getBoundingClientRect(),l=window.innerHeight||document.documentElement.clientHeight,s=window.innerWidth||document.documentElement.clientWidth;return i.bottom>0&&i.top<l&&i.right>0&&i.left<s}function ae(i){if(!a||i.target&&(i.target.tagName==="INPUT"||i.target.tagName==="TEXTAREA")||!Ee())return;let l=i.key;if(l>="1"&&l<="4"){let s=Number(l)-1;a.checked[a.idx]||(ie(s),i.preventDefault())}else if(l==="Enter"){let s=e.querySelector("[data-zq-check]"),b=e.querySelector("[data-zq-next]");s&&!s.disabled?(re(),i.preventDefault()):b&&(b.click(),i.preventDefault())}}document.addEventListener("keydown",ae);function Ie(){H(),V&&V.disconnect(),document.removeEventListener("keydown",ae),_(e)}function Te(i){a&&(a.remainingSec=i,ee())}return G(),{destroy:Ie,__debugSetRemainingSec:Te}}function qe(){let e=document.getElementById("ziptility-practice");if(!e||e.dataset.zipBooted)return;if(e.dataset.zipBooted="1",!document.getElementById("zpt-practice-styles")){let o=document.createElement("style");o.id="zpt-practice-styles",o.textContent=se,document.head.appendChild(o)}if(!document.getElementById("zpt-practice-fonts")){let o=document.createElement("link");o.rel="preconnect",o.href="https://fonts.googleapis.com";let y=document.createElement("link");y.rel="preconnect",y.href="https://fonts.gstatic.com",y.crossOrigin="anonymous";let S=document.createElement("link");S.id="zpt-practice-fonts",S.rel="stylesheet",S.href="https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;600;700;800;900&family=Geist:wght@400;500;600&display=swap",document.head.append(o,y,S)}let r=!1,n=null;try{let o=new URLSearchParams(window.location.search);r=o.get("embed")==="app",n=o.get("test")}catch{}r||(r=e.dataset.embed==="app"),n||(n=e.dataset.test||null),r&&e.classList.add("zq-embed-app");let c=e.dataset.bankBase||de;e.innerHTML="";let f=document.createElement("div");f.className="zq-wrap",e.appendChild(f);let m=null;function C(){m&&(m.destroy(),m=null),pe(f,{onSelect:z})}function z(o){ue(f),le(o.id,o.bankVersion,c).then(y=>{let S={...ce,embedApp:r,title:o.title,badge:o.badge};m=ve(f,y,S,{onExit:C}),e.dataset.debug==="1"&&(e.__zqDebug=m)}).catch(()=>{fe(f,{message:'Could not load "'+o.title+'." Check your connection and try again.',onRetry:()=>z(o)})})}if(n){let o=D.find(y=>y.id===n);o?z(o):C()}else C()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",qe):qe();})();
