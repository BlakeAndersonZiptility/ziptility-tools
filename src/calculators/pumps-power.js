...
export default [
  ...
  { id:"hp", cat:"Pumps & Power", domains:["water","wastewater"], title:"Brake Horsepower & Cost", formula:"hp = (gpm × head × SG) ÷ (3960 × Eff%)", formulaSI:"kW = (L/s × head × SG × 9.81) ÷ (1000 × Eff%)", note:"Enter two of gpm/head/hp + efficiency. SG defaults to 1.",
  ...
  { id:"water-hp", cat:"Pumps & Power", domains:["water","wastewater"], title:"Water Horsepower", formula:"whp = (gpm × head) ÷ 3960", formulaSI:"wkW = (L/s × head × 9.81) ÷ 1000", note:"Theoretical hp (no losses). Enter two values.",
  ...
  { id:"motor-hp", cat:"Pumps & Power", domains:["water","wastewater"], title:"Motor Horsepower", formula:"mhp = (gpm × head) ÷ (3960 × Pump% × Motor%)", formulaSI:"mkW = (L/s × head × 9.81) ÷ (1000 × Pump% × Motor%)", note:"Enter gpm, head, pump & motor efficiency.",
  ...
  { id:"wire-to-water", cat:"Pumps & Power", domains:["water","wastewater"], title:"Wire-to-Water Efficiency", formula:"Water hp ÷ Motor hp × 100 = %", formulaSI:"Water kW ÷ Motor kW × 100 = %", note:"Overall pump+motor efficiency. Enter any two.",
  ...
  { id:"elec-power", cat:"Pumps & Power", domains:["water","wastewater"], title:"Electrical Power", formula:"Watts = Volts × Amps", note:"Enter any two values.",
    ...
    solve:(v)=>{ if(v.v!=null&&v.a!=null) return {values:{w:v.v*v.a},computed:["w"],error:""};
      ...
      return {values:{},computed:[],error:"Enter any two values."}; }},
  { id:"op-cost", cat:"Pumps & Power", domains:["water","wastewater"], title:"Equipment Operating Cost", formula:"$/hr = hp × 0.746 × $/kWh ÷ Motor%", formulaSI:"$/hr = kW × $/kWh ÷ Motor%", note:"Enter hp + power price. Motor efficiency defaults to 100%; add hours/day for a daily cost.",
  ...
  { id:"specific-energy", cat:"Pumps & Power", domains:["water","wastewater"], title:"Pump Specific Energy & Cost", formula:"kWh/MG = kWh ÷ MG pumped · $/MG = kWh/MG × $/kWh", formulaSI:"kWh/ML = kWh ÷ ML pumped · $/ML = kWh/ML × $/kWh", note:"Energy per million gallons. Fill in Pump B to compare two pumps side by side.",
