/* Ziptility Practice Tests practice-v1.8.0 (2139f018612f4b78e8f23090607d3677a12aa431) — https://github.com/BlakeAndersonZiptility/ziptility-tools */
(()=>{var be=`/* Ziptility practice tests: DS 4.0 reskin, ported from
...
`;var $={calcUrl:"/tools/calculator",formulaSheetUrl:"/tools/formula-sheets",contactEmail:"sales@ziptility.com",hubUrl:"/tools/practice"};var ve="https://blakeandersonziptility.github.io/ziptility-tools/dist/practice-banks/",Y=[{id:"operator-math-1",slug:"operator-math",title:"Operator math practice test",badge:"Operator math \xB7 Levels 1-2 (ABC Class I-II)",discipline:"Operator Math",level:"Levels 1-2 (ABC Class I-II)",description:"Unit conversions, flow, dosing, and the 8.34 pounds formula, worked out in plain English.",questionCount:110,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"regulations-1",slug:"regulations",title:"Water and wastewater regulations practice test (federal)",badge:"Federal regulations \xB7 Entry to working level",discipline:"Regulations (Federal)",level:"Entry to working level (ABC Class I-II)",description:"The federal rules an operator answers to: the Safe Drinking Water Act, the Clean Water Act, monitoring and reporting, public notice, and recordkeeping. Every answer carries a citation.",questionCount:103,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"wd-1",slug:"water-distribution",title:"Water distribution operator practice test, Class I",badge:"Water distribution \xB7 Class I entry level",discipline:"Water Distribution",level:"Entry level (ABC Class I)",description:"Mains, valves, hydrants, storage, pumps, cross-connection control, flushing, sampling, and crew safety. Machine-checked math and cited answers.",questionCount:125,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"wwc-1",slug:"wastewater-collection",title:"Wastewater collection operator practice test, Class I",badge:"Wastewater collection \xB7 Class I entry level",discipline:"Wastewater Collections",level:"Entry level (ABC Class I)",description:"Gravity mains, manholes, lift stations, cleaning and CCTV, infiltration and inflow, SSO response, and confined-space and trench safety. Cited answers throughout.",questionCount:120,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"wt-1",slug:"water-treatment",title:"Water treatment operator practice test, Class I",badge:"Water treatment \xB7 Class I entry level",discipline:"Water Treatment",level:"Entry level (ABC Class I)",description:"Coagulation and jar testing, sedimentation, filtration, disinfection and CT, source water, plant pumps and chemical feeders, lab work, and chlorine safety. Machine-checked math and cited answers.",questionCount:128,durationMin:120,refCount:100,bankVersion:"1.0.0"},{id:"wwt-1",slug:"wastewater-treatment",title:"Wastewater treatment operator practice test, Class I",badge:"Wastewater treatment \xB7 Class I entry level",discipline:"Wastewater Treatment",level:"Entry level (ABC Class I)",description:"Preliminary and primary treatment, activated sludge, clarifiers, trickling filters and lagoons, disinfection, solids handling, blowers and clarifier drives, lab work, and H2S and confined-space safety. Cited answers throughout.",questionCount:119,durationMin:120,refCount:100,bankVersion:"1.0.0"}];function We(e){let t=new Set,o=new Set;for(let a of e){if(!a||!a.id)throw new Error("practice manifest: entry missing id");if(t.has(a.id))throw new Error('practice manifest: duplicate id "'+a.id+'"');if(t.add(a.id),!/^[a-z0-9]+(-[a-z0-9]+)*$/.test(a.slug||""))throw new Error('practice manifest: "'+a.id+'" has a missing or non-kebab-case slug');if(o.has(a.slug))throw new Error('practice manifest: duplicate slug "'+a.slug+'"');if(o.add(a.slug),!a.title||!a.badge||!a.discipline||!a.level||!a.description)throw new Error('practice manifest: "'+a.id+'" is missing a required label field');if(!Number.isInteger(a.questionCount)||a.questionCount<=0)throw new Error('practice manifest: "'+a.id+'" has a bad questionCount');if(!Number.isInteger(a.durationMin)||a.durationMin<=0)throw new Error('practice manifest: "'+a.id+'" has a bad durationMin');if(!Number.isInteger(a.refCount)||a.refCount<=0)throw new Error('practice manifest: "'+a.id+'" has a bad refCount');if(!/^\d+\.\d+\.\d+$/.test(a.bankVersion||""))throw new Error('practice manifest: "'+a.id+'" has a malformed bankVersion')}for(let a of e)if(t.has(a.slug)&&a.slug!==a.id)throw new Error('practice manifest: slug "'+a.slug+'" collides with another test id');return!0}We(Y);var Z=new Map;async function qe(e,t,o){let a=e+"-v"+t;if(Z.has(a))return Z.get(a);let p=o+a+".json",u=new AbortController,v=setTimeout(()=>u.abort(),1e4),h;try{h=await fetch(p,{signal:u.signal})}finally{clearTimeout(v)}if(!h.ok)throw new Error("practice bank fetch failed: "+p+" ("+h.status+")");let f=await h.json();return Z.set(a,f),f}function C(e,t,o){let a=document.createElement(e);return t&&(a.className=t),o!=null&&(a.textContent=o),a}function ee(e){for(;e.firstChild;)e.removeChild(e.firstChild)}var Ye=new Set(["operator-math-1","regulations-1"]);function ye(e,{onSelect:t,childPages:o=!1,hubUrl:a="/tools/practice"}){ee(e),e.appendChild(C("h2","zq-hub-section-title","Pick your test"));let p=String(a).replace(/\/+$/,""),u=C("div","zq-hub-grid"),v=!1;Y.forEach(h=>{let f=Ye.has(h.id);!f&&!v&&(u.appendChild(C("div","zq-hub-groupdivider","By discipline")),v=!0);let q=C(o?"a":"button","zq-hubcard"+(f?" zq-hubcard-featured":""));o?q.href=p+"/"+h.slug:q.type="button",q.appendChild(C("span","zq-eyebrow",h.discipline)),q.appendChild(C("h3",null,h.title)),q.appendChild(C("p",null,h.description||""));let m=C("div","zq-hubcard-stat");m.appendChild(C("span","zq-hubcard-stat-num",String(h.questionCount))),m.appendChild(C("span","zq-hubcard-stat-label","questions in the bank")),q.appendChild(m),q.appendChild(C("div","zq-meta","Practice or timed exam")),o||q.addEventListener("click",()=>t(h)),u.appendChild(q)}),e.appendChild(u)}function we(e){ee(e);let t=C("div","zq-loading");t.appendChild(C("span","zq-spinner")),t.appendChild(C("span",null,"Loading questions\u2026")),e.appendChild(t)}function te(e,{message:t,onRetry:o,hubUrl:a}){ee(e);let p=C("div","zq-error");if(p.setAttribute("role","alert"),p.appendChild(C("h3",null,"Could not load this test")),p.appendChild(C("p",null,t||"The question set did not load. Check your connection and try again.")),o){let u=C("button","zq-btn zq-btn-secondary","Try again");u.type="button",u.addEventListener("click",o),p.appendChild(u)}if(a){let u=C("a","zq-btn zq-btn-secondary","All practice tests");u.href=a,p.appendChild(u)}e.appendChild(p)}function F(e){for(let t=e.length-1;t>0;t--){let o=Math.floor(Math.random()*(t+1)),a=e[t];e[t]=e[o],e[o]=a}return e}function ie(e){let t=Math.floor(e/60),o=e%60;return t+":"+(o<10?"0":"")+o}function xe(e){let t=[],o=[25,50,100];for(let a of o)a<e&&t.push(a);return t.push(e),t}function re(e,t,o,a){let p=t||o;return Math.max(10,Math.round((a||120)*e/p))}function Ce(e,t,o){let a=new Set(t||[]),p=[],u=[];for(let h of e)(a.has(h.id)?u:p).push(h);F(p),F(u);let v=p.concat(u).slice(0,o);return F(v),v.map(h=>{let f=F([0,1,2,3]);return{q:h,order:f,correctPos:f.indexOf(h.correctIndex)}})}function ke(e,t){let o=e.length,a=0,p={},u=[];for(let h=0;h<o;h++){let f=e[h],q=f.q.domain||"General";p[q]||(p[q]={n:0,ok:0}),p[q].n+=1;let m=h in t?t[h]:null;m===f.correctPos?(a+=1,p[q].ok+=1):u.push({item:f,sel:m})}let v=Math.round(100*a/o);return{correct:a,n:o,pct:v,byDomain:p,missed:u}}function Se(e){return Object.keys(e).sort((t,o)=>e[t].ok/e[t].n-e[o].ok/e[o].n)}var He="tool_complete",Ve="tool_progress";function Ee(e){try{if(typeof window>"u")return;window.dataLayer=window.dataLayer||[],window.dataLayer.push(e)}catch{}}function ne(e,t){if(!e)return;let o={event:He,tool_name:String(e)};t&&typeof t=="object"&&Object.keys(t).forEach(a=>{let p=t[a];p==null||p===""||typeof p!="object"&&(o["tool_"+a]=typeof p=="number"?p:String(p))}),Ee(o)}function Te(e,t,o){!e||!o||Ee({event:Ve,tool_name:String(e),tool_answered:Number(t),tool_total:Number(o),tool_percent:Math.round(Number(t)/Number(o)*100)})}function ae(e){let t={},o=(e||[25,50,75]).slice().sort((a,p)=>a-p);return function(p,u){if(!u)return null;let v=p/u*100;for(let h=o.length-1;h>=0;h--){let f=o[h];if(v>=f&&!t[f])return t[f]=!0,f}return null}}var Fe="zip-units";var Q=null;function Qe(e){return e==="metric"?"metric":"imperial"}function Ie(){if(Q)return Q;let e=null;try{e=window.localStorage.getItem(Fe)}catch{e=null}return Q=Qe(e),Q}var oe={MATH:"Operator math",CHEM:"Chemistry",MICRO:"Microbiology",REGS:"Regulations",SAMP:"Sampling",SAFE:"Safety",PROC:"Process control",EQIP:"Equipment",ADMIN:"Administration",Multiple:"Mixed topics"};function Ke(e){try{return window.localStorage.getItem(e)}catch{return null}}function se(e,t){try{window.localStorage.setItem(e,t)}catch{}}function Xe(e){try{window.localStorage.removeItem(e)}catch{}}function j(e){let t=Ke(e);if(!t)return null;try{return JSON.parse(t)}catch{return null}}function r(e,t,o){let a=document.createElement(e);return t&&(a.className=t),o!=null&&(a.textContent=o),a}function H(e){for(;e.firstChild;)e.removeChild(e.firstChild)}var Je='<svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 8h10M9 4l4 4-4 4"/></svg>';function L(e,t,{arrow:o=!1}={}){let a=r("button",t);a.type="button";let p=r("span","zq-btn-label",e);if(a.appendChild(p),o){let u=document.createElement("span");u.className="zq-arrow",u.innerHTML=Je,a.appendChild(u)}return a}function $e(e,t){let o=e.querySelector(".zq-btn-label");o&&(o.textContent=t)}function Ae(e,t,o,{onExit:a}={}){let p="zpt-pt-session-"+t.id,u="zpt-pt-history-"+t.id,v="zpt-pt-seen-"+t.id,h={};for(let n of t.questions)h[n.id]=n;H(e);let f=r("div"),q=r("div","zq-visually-hidden");q.setAttribute("aria-live","polite"),e.appendChild(f),e.appendChild(q);function m(n){q.textContent=n}let i=null,N="practice-"+(o.slug||t.id),G=ae([25,50,75]);function ce(n,c){if(G=ae([25,50,75]),n>0)for(let s=0;s<4&&G(n,c);s++);}function Le(){try{let n=Object.keys(i.answers).length;G(n,i.qs.length)&&Te(N,n,i.qs.length)}catch{}}let E={mode:"practice",size:null};function _(){i&&se(p,JSON.stringify({v:1,bankVersion:t.version||"",mode:i.mode,size:i.size,qids:i.qs.map(n=>n.q.id),orders:i.qs.map(n=>n.order),answers:i.answers,checked:i.checked,idx:i.idx,remainingSec:i.remainingSec}))}function Ne(){let n=j(p);if(!n||n.v!==1||n.bankVersion!==(t.version||"")||!n.qids||!n.qids.length)return null;for(let c of n.qids)if(!h[c])return null;return n}function K(){Xe(p)}function Oe(n){let c=j(u)||[];c.unshift(n),c.length>25&&(c=c.slice(0,25)),se(u,JSON.stringify(c))}function Be(n){let s=(j(v)||[]).concat(n);s.length>600&&(s=s.slice(s.length-600)),se(v,JSON.stringify(s))}function le(){let n=Ie()==="metric";return r("p","zq-note zq-units-note",n?"Your calculator is set to metric. These practice questions still use US customary exam-sheet units (gallons, feet, MGD, lb/day), the way the exam sheet does. Metric question sets follow.":"Math questions use US customary exam-sheet units (gallons, feet, MGD, lb/day), the way the exam sheet does.")}function X(){V(),i=null,H(f);let n=r("div");n.appendChild(r("span","zq-badge",o.badge||t.discipline||"")),n.appendChild(r("h2","zq-title",o.title||t.title)),n.appendChild(le()),f.appendChild(n);let c=Ne();if(c){let l=r("div","zq-resume"),g=r("div");g.appendChild(r("strong",null,"You have a test in progress. ")),g.appendChild(document.createTextNode((c.mode==="exam"?"Timed exam":"Practice")+", question "+(c.idx+1)+" of "+c.qids.length+".")),l.appendChild(g);let z=r("div","zq-navrow"),d=L("Resume","zq-btn zq-btn-primary",{arrow:!0});d.addEventListener("click",()=>Pe(c));let S=L("Discard","zq-btn zq-btn-quiet");S.addEventListener("click",()=>{K(),X()}),z.appendChild(d),z.appendChild(S),l.appendChild(z),f.appendChild(l)}let s=r("div","zq-card");s.appendChild(r("h2",null,"Set up your test"));let y=r("div","zq-mode-grid"),w=[{id:"practice",name:"Practice",desc:"Check each answer as you go. Every question shows a plain-English explanation."},{id:"exam",name:"Timed exam",desc:"No feedback until the end, with a clock running. The closest thing to test day."}],x={};w.forEach(l=>{let g=r("button","zq-mode"+(E.mode===l.id?" zq-selected":""));g.type="button",g.appendChild(r("h3",null,l.name)),g.appendChild(r("p",null,l.desc)),g.addEventListener("click",()=>{E.mode=l.id;for(let z in x)x[z].classList.toggle("zq-selected",z===l.id);I()}),x[l.id]=g,y.appendChild(g)}),s.appendChild(y);let b=xe(t.questions.length);(E.size===null||b.indexOf(E.size)===-1)&&(E.size=b[0]);let O=r("div","zq-size-row"),B={};b.forEach(l=>{let g=r("button","zq-size"+(E.size===l?" zq-selected":""));g.type="button",g.appendChild(document.createTextNode(l===t.questions.length&&b.length>1?"All "+l:String(l))),g.appendChild(r("small",null,"questions")),g.addEventListener("click",()=>{E.size=l;for(let z in B)B[z].classList.toggle("zq-selected",Number(z)===l);I()}),B[l]=g,O.appendChild(g)}),s.appendChild(O);let M=r("div","zq-navrow"),R=L("","zq-btn zq-btn-primary",{arrow:!0});R.addEventListener("click",()=>de(E.mode,E.size)),M.appendChild(R),s.appendChild(M),f.appendChild(s);function I(){$e(R,E.mode==="exam"?"Start timed exam ("+E.size+" questions, "+re(E.size,t.refCount,t.questions.length,t.durationMin)+" min)":"Start practice ("+E.size+" questions)")}I();let T=j(u)||[];if(T.length){let l=0;for(let g of T)g.scorePct>l&&(l=g.scorePct);f.appendChild(r("p","zq-best","Your best score on this test so far: "+l+" percent. Attempts: "+T.length+"."))}}function de(n,c){K();let s=j(v)||[];i={mode:n,size:c,qs:Ce(t.questions,s,c),idx:0,answers:{},checked:{},remainingSec:n==="exam"?re(c,t.refCount,t.questions.length,t.durationMin)*60:0,timerId:null},_(),ce(0,i.qs.length),n==="exam"&&ue(),D()}function Pe(n){i={mode:n.mode,size:n.size,qs:n.qids.map((c,s)=>{let y=h[c],w=n.orders[s];return{q:y,order:w,correctPos:w.indexOf(y.correctIndex)}}),idx:n.idx||0,answers:n.answers||{},checked:n.checked||{},remainingSec:n.remainingSec||0,timerId:null},ce(Object.keys(i.answers).length,i.qs.length),i.mode==="exam"&&ue(),D()}function pe(){let n=e.querySelector(".zq-timer");n&&(n.textContent=ie(Math.max(0,i.remainingSec)),n.classList.toggle("zq-low",i.remainingSec<=120)),i.remainingSec%15===0&&_(),i.remainingSec<=0&&(m("Time is up. Scoring your exam."),J())}function ue(){V(),i.timerId=setInterval(()=>{i.remainingSec-=1,pe()},1e3)}function V(){i&&i.timerId&&(clearInterval(i.timerId),i.timerId=null)}function D(){H(f);let n=i.qs[i.idx],c=n.q,s=i.qs.length,y=!!i.checked[i.idx],w=i.idx in i.answers?i.answers[i.idx]:null,x=r("div","zq-topbar"),b=r("div");if(b.appendChild(document.createTextNode("Question "+(i.idx+1)+" of "+s+"  ")),b.appendChild(r("span","zq-domchip",oe[c.domain]||c.domain||"General")),x.appendChild(b),i.mode==="exam"){let l=r("span","zq-timer",ie(Math.max(0,i.remainingSec)));i.remainingSec<=120&&l.classList.add("zq-low"),x.appendChild(l)}f.appendChild(x);let O=r("div","zq-progressbar"),B=r("i");B.style.width=Math.round(100*i.idx/s)+"%",O.appendChild(B),f.appendChild(O);let M=r("div","zq-card");M.appendChild(r("div","zq-stem",c.text));let R=r("ul","zq-choices"),I=["A","B","C","D"];n.order.forEach((l,g)=>{let z=r("li"),d=r("button","zq-choice");d.type="button",d.appendChild(r("span","zq-letter",I[g])),d.appendChild(r("span",null,c.choices[l])),w===g&&d.classList.add("zq-selected"),y?(d.disabled=!0,g===n.correctPos?(d.classList.remove("zq-selected"),d.classList.add("zq-correct")):w===g&&(d.classList.remove("zq-selected"),d.classList.add("zq-wrong"))):d.addEventListener("click",()=>he(g)),z.appendChild(d),R.appendChild(z)}),M.appendChild(R),y&&M.appendChild(Re(n,w));let T=r("div","zq-navrow");if(i.mode==="exam"){let l=L("Previous","zq-btn zq-btn-quiet");if(l.disabled=i.idx===0,l.addEventListener("click",()=>{i.idx-=1,_(),D()}),T.appendChild(l),T.appendChild(r("span","zq-spacer")),i.idx<s-1){let d=L("Next","zq-btn zq-btn-primary",{arrow:!0});d.addEventListener("click",()=>{i.idx+=1,_(),D()}),T.appendChild(d)}let g=0;for(let d in i.answers)i.answers[d]!==null&&g++;let z=L("Submit ("+g+"/"+s+" answered)",i.idx===s-1?"zq-btn zq-btn-primary":"zq-btn zq-btn-secondary");z.addEventListener("click",()=>{g<s&&!window.confirm("You have unanswered questions. Submit anyway?")||J()}),T.appendChild(z)}else if(T.appendChild(r("span","zq-spacer")),y){let l=L(i.idx<s-1?"Next question":"See your score","zq-btn zq-btn-primary",{arrow:!0});l.setAttribute("data-zq-next",""),l.addEventListener("click",()=>{i.idx<s-1?(i.idx+=1,_(),D()):J()}),T.appendChild(l)}else{let l=L("Check answer","zq-btn zq-btn-primary");l.setAttribute("data-zq-check",""),l.disabled=w===null,l.addEventListener("click",fe),T.appendChild(l)}M.appendChild(T),f.appendChild(M);try{e.scrollIntoView({block:"start"})}catch{}}function he(n){i.answers[i.idx]=n,_(),Le(),D()}function fe(){if(!(i.idx in i.answers))return;i.checked[i.idx]=!0,_();let n=i.qs[i.idx];m(i.answers[i.idx]===n.correctPos?"Correct.":"Not quite. The explanation is shown below."),D()}function Re(n,c){let s=n.q,y=c===n.correctPos,w=r("div","zq-feedback "+(y?"zq-ok":"zq-err"));w.appendChild(r("h4",y?"zq-okt":"zq-errt",y?"Correct":"Not quite")),s.explanation&&w.appendChild(r("p","zq-explain",s.explanation)),s.formula&&w.appendChild(r("div","zq-formula",s.formula)),s.citation&&w.appendChild(r("div","zq-cite","Source: "+s.citation));let x=r("div","zq-minilinks");if(s.calculator&&o.calcUrl){let b=r("a",null,"Run this math in the Operator Calculator");b.href=o.calcUrl+"#"+s.calculator,b.target="_blank",b.rel="noopener",x.appendChild(b)}if(o.contactEmail){let b=r("a",null,"Report a problem with this question");b.href="mailto:"+o.contactEmail+"?subject="+encodeURIComponent("Practice test question "+s.id),x.appendChild(b)}return x.childNodes.length&&w.appendChild(x),w}function J(){V();let{correct:n,n:c,pct:s,byDomain:y,missed:w}=ke(i.qs,i.answers);if(!i.completeSent){i.completeSent=!0;try{let x=(j(u)||[]).length;ne(N,{mode:i.mode,size:c,score_pct:s,passed:s>=70?"yes":"no",attempt:x+1,deep_linked:o.deepLinked?"yes":"no"})}catch{ne(N)}}Oe({date:new Date().toISOString().slice(0,10),mode:i.mode,size:c,scorePct:s}),Be(i.qs.map(x=>x.q.id)),K(),_e(s,n,c,y,w)}function _e(n,c,s,y,w){H(f);let x=n>=70,b=r("div","zq-card zq-score-hero");b.appendChild(r("div","zq-score-num "+(x?"zq-pass":"zq-fail"),n+"%")),b.appendChild(r("div","zq-score-verdict "+(x?"zq-tag-ok":"zq-tag-err"),x?"Pass at the 70 percent line":"Below the 70 percent line")),b.appendChild(r("div","zq-score-sub",c+" of "+s+" correct"+(i.mode==="exam"?" on a timed exam":""))),b.appendChild(r("p","zq-passnote","Most states set the pass line at 70 percent. Your state's rules govern, so check your certification program for the real requirement.")),b.appendChild(le()),m("You scored "+n+" percent, "+c+" of "+s+" correct. "+(x?"That clears the 70 percent line.":"That is below the 70 percent line."));let O=r("div","zq-navrow zq-navrow-center"),B=L("Take it again (new draw)","zq-btn zq-btn-primary",{arrow:!0});B.addEventListener("click",()=>de(i.mode,s));let M=L("Change setup","zq-btn zq-btn-secondary");M.addEventListener("click",X);let R=o.deepLinked&&o.hubUrl,I;if(R?(I=r("a","zq-btn zq-btn-quiet"),I.href=o.hubUrl,I.appendChild(r("span","zq-btn-label","All practice tests"))):(I=L("All practice tests","zq-btn zq-btn-quiet"),I.addEventListener("click",()=>{a&&a()})),O.appendChild(B),O.appendChild(M),O.appendChild(I),b.appendChild(O),f.appendChild(b),Object.keys(y).length>1){let z=r("div","zq-card zq-dombars");z.appendChild(r("h3",null,"Where you stand by topic")),Se(y).forEach(d=>{let S=y[d],k=Math.round(100*S.ok/S.n),A=r("div","zq-dombar"+(k<70?" zq-weak":"")),U=r("div","zq-domlabel");U.appendChild(r("span",null,oe[d]||d)),U.appendChild(r("span",null,S.ok+"/"+S.n+" ("+k+"%)")),A.appendChild(U);let P=r("div","zq-track"),ze=r("span","zq-fill");ze.style.width=k+"%",P.appendChild(ze),A.appendChild(P),z.appendChild(A)}),f.appendChild(z)}if(w.length){let z=r("div","zq-card zq-missed");z.appendChild(r("h3",null,"Review what you missed ("+w.length+")")),w.forEach(d=>{let S=r("details");S.appendChild(r("summary",null,d.item.q.text));let k=r("div","zq-missed-body"),A=["A","B","C","D"];if(d.sel!==null&&d.sel!==void 0){let P=r("p");P.appendChild(r("span","zq-tag-err","Your answer: ")),P.appendChild(document.createTextNode(A[d.sel]+". "+d.item.q.choices[d.item.order[d.sel]])),k.appendChild(P)}else{let P=r("p");P.appendChild(r("span","zq-tag-err","Skipped.")),k.appendChild(P)}let U=r("p");U.appendChild(r("span","zq-tag-ok","Correct answer: ")),U.appendChild(document.createTextNode(A[d.item.correctPos]+". "+d.item.q.choices[d.item.q.correctIndex])),k.appendChild(U),d.item.q.explanation&&k.appendChild(r("p","zq-explain",d.item.q.explanation)),d.item.q.formula&&k.appendChild(r("div","zq-formula",d.item.q.formula)),d.item.q.citation&&k.appendChild(r("div","zq-cite","Source: "+d.item.q.citation)),S.appendChild(k),z.appendChild(S)}),f.appendChild(z)}let l=r("div","zq-capture-slot");l.hidden=!0,f.appendChild(document.createComment(" soft-capture slot: reserved, ruling 2026-07-10 ")),f.appendChild(l);let g=j(u)||[];if(g.length>1){let z=r("div","zq-card zq-history");z.appendChild(r("h3",null,"Your attempts on this test"));let d=r("table"),S=r("tr");["Date","Mode","Questions","Score"].forEach(k=>S.appendChild(r("th",null,k))),d.appendChild(S),g.slice(0,8).forEach(k=>{let A=r("tr");A.appendChild(r("td",null,k.date)),A.appendChild(r("td",null,k.mode==="exam"?"Timed":"Practice")),A.appendChild(r("td",null,String(k.size))),A.appendChild(r("td",null,k.scorePct+"%")),d.appendChild(A)}),z.appendChild(d),f.appendChild(z)}}let me=!0,W=null;typeof IntersectionObserver=="function"&&(W=new IntersectionObserver(n=>{for(let c of n)me=c.isIntersecting},{threshold:0}),W.observe(e));function De(){if(W)return me;let n=e.getBoundingClientRect(),c=window.innerHeight||document.documentElement.clientHeight,s=window.innerWidth||document.documentElement.clientWidth;return n.bottom>0&&n.top<c&&n.right>0&&n.left<s}function ge(n){if(!i||n.target&&(n.target.tagName==="INPUT"||n.target.tagName==="TEXTAREA")||!De())return;let c=n.key;if(c>="1"&&c<="4"){let s=Number(c)-1;i.checked[i.idx]||(he(s),n.preventDefault())}else if(c==="Enter"){let s=e.querySelector("[data-zq-check]"),y=e.querySelector("[data-zq-next]");s&&!s.disabled?(fe(),n.preventDefault()):y&&(y.click(),n.preventDefault())}}document.addEventListener("keydown",ge);function Ue(){V(),W&&W.disconnect(),document.removeEventListener("keydown",ge),H(e)}function je(n){i&&(i.remainingSec=n,pe())}return X(),{destroy:Ue,__debugSetRemainingSec:je}}function Me(){let e=document.getElementById("ziptility-practice");if(!e||e.dataset.zipBooted)return;if(e.dataset.zipBooted="1",!document.getElementById("zpt-practice-styles")){let m=document.createElement("style");m.id="zpt-practice-styles",m.textContent=be,document.head.appendChild(m)}if(!document.getElementById("zpt-practice-fonts")){let m=document.createElement("link");m.rel="preconnect",m.href="https://fonts.googleapis.com";let i=document.createElement("link");i.rel="preconnect",i.href="https://fonts.gstatic.com",i.crossOrigin="anonymous";let N=document.createElement("link");N.id="zpt-practice-fonts",N.rel="stylesheet",N.href="https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;600;700;800;900&family=Geist:wght@400;500;600&display=swap",document.head.append(m,i,N)}let t=!1,o=null;try{let m=new URLSearchParams(window.location.search);t=m.get("embed")==="app",o=m.get("test")}catch{}t||(t=e.dataset.embed==="app"),o||(o=e.dataset.test||null),t&&e.classList.add("zq-embed-app");let a=e.dataset.childPages==="1",p=e.dataset.bankBase||ve,u=e.dataset.hubUrl||$.hubUrl;e.innerHTML="";let v=document.createElement("div");v.className="zq-wrap",e.appendChild(v);let h=null;function f(){h&&(h.destroy(),h=null),ye(v,{onSelect:q,childPages:a,hubUrl:u})}function q(m,i){we(v),qe(m.id,m.bankVersion,p).then(N=>{let G={...$,embedApp:t,hubUrl:u,title:m.title,badge:m.badge,deepLinked:!!i,slug:m.slug};h=Ae(v,N,G,{onExit:i?null:f}),e.dataset.debug==="1"&&(e.__zqDebug=h)}).catch(()=>{te(v,{message:'Could not load "'+m.title+'." Check your connection and try again.',onRetry:()=>q(m,i)})})}if(o){let m=Y.find(i=>i.slug===o||i.id===o);m?q(m,!0):te(v,{message:'This practice test is not available at "'+o+'." Pick a test from the full list instead.',hubUrl:u})}else f()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Me):Me();})();
