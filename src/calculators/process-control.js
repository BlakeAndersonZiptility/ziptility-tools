...
export default [
  ...
  { id:"fm-ratio", cat:"Process Control", domains:["wastewater"], title:"F / M Ratio", formula:"(BOD × Flow) ÷ (MLVSS × Volume)", note:"Food-to-microorganism ratio. Enter all but one.",
    fields:[{k:"bod",label:"BOD mg/L"},{k:"mgd",label:"Flow",unit:"flow",def:"mgd",base:"mgd",units:["mgd","gpm","gpd","MLd","m3d","Lps"]},{k:"mlvss",label:"MLVSS mg/L"},{k:"mg",label:"Aeration volume",unit:"volume",def:"MG",base:"MG",units:["MG","gal","ML","m3"]},{k:"fm",label:"F/M Ratio"}],
  ...
  { id:"ras-rate", cat:"Process Control", domains:["wastewater"], title:"Return (RAS) Rate", formula:"Return flow ÷ Influent flow × 100 = %", note:"Enter any two values.",
    fields:[{k:"ras",label:"Return",unit:"flow",def:"mgd",base:"mgd",units:["mgd","gpm","gpd","MLd","m3d","Lps"]},{k:"inf",label:"Influent",unit:"flow",def:"mgd",base:"mgd",units:["mgd","gpm","gpd","MLd","m3d","Lps"]},{k:"pct",label:"Return %"}],
  ...
  { id:"recirculation", cat:"Process Control", domains:["wastewater"], title:"Recirculation Ratio", formula:"Recirculated flow ÷ Influent flow = Ratio", note:"Trickling filter. Enter any two values.",
    fields:[{k:"rec",label:"Recirc",unit:"flow",def:"mgd",base:"mgd",units:["mgd","gpm","gpd","MLd","m3d","Lps"]},{k:"inf",label:"Influent",unit:"flow",def:"mgd",base:"mgd",units:["mgd","gpm","gpd","MLd","m3d","Lps"]},{k:"ratio",label:"Ratio"}],
