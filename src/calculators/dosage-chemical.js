...
export default [
  ...
  { id:"chem-feed", cat:"Dosage & Chemical", domains:["water","wastewater"], title:"Chemical Feed Rate", formula:"(Dose × Flow MGD × 8.34) ÷ Purity = lbs/day", formulaSI:"(Dose × Flow ML/d) ÷ Purity = kg/d", note:"Enter dose + flow. Purity defaults to 100%.",
    fields:[{k:"dose",label:"Dose mg/L"},{k:"mgd",label:"Flow",unit:"flow",def:"mgd",base:"mgd",units:["mgd","gpm","gpd","MLd","m3d","Lps"]},{k:"pur",label:"Purity %"},{k:"feed",label:"Feed lbs/day"}],
